...
public class UndoRedoStack {
    ...
    /**
     * Pops the address book from the undo-stack and pushes the it into the redo-stack, and returns
     * the new top address book of the undo-stack.
     */
    ...
    /**
     * Pops the address book from the redo-stack and pushes the it into the undo-stack, and returns
