...
public class ChangeCommand extends Command {
    ...
    private static final String INITIAL_VIEW_PAGE = "d";

    private static String viewPage = INITIAL_VIEW_PAGE;

    /**
     * Creates an ChangeCommand to change calendar into the specified view page {@code viewPage}
     */
    public ChangeCommand(String viewPage) {
    ...
    public CommandResult execute() {
        CalendarPanel.changeViewPage(viewPage.charAt(INDEX_OF_TIME_UNIT));
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                ...
                && viewPage.equals(((ChangeCommand) other).viewPage));
    }
