...
public class LoginCommand extends Command{
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Enables the use of the application by logging in using " +
            "the specified personnel's NRIC and password.\n" +
    ...
    String dummyNRIC = "S9123456Q";
    String dummyPassword = "qwerty";
    String loginNRIC, loginPassword;
