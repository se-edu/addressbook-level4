...
public class CliSyntax {
    ...
    public static final Prefix PREFIX_PURCHASENAME = new Prefix("pn/");
    public static final Prefix PREFIX_HABITTITLE = new Prefix("ht/");
    public static final Prefix PREFIX_PROGRESS = new Prefix("pg/");
