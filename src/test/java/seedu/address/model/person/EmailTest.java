...
public class EmailTest {
    ...
    public void isValidEmail() {
        ...
        assertFalse(Email.isValidEmail("peterjack@.example.com")); // domain name starts with a dot
        assertFalse(Email.isValidEmail("peterjack@example.com.")); // domain name ends with a dot
        ...
        assertTrue(Email.isValidEmail("_user_@example.com")); // underscores
