...
/**
 * Contains integration tests (interaction with the Model, UndoCommand and RedoCommand) and unit tests for EditMemberCommand.
 */
public class EditMemberCommandTest {
    ...
    public void execute_someFieldsSpecifiedUnfilteredList_success() {
        ...
        EditMemberCommand editMemberCommand = new EditMemberCommand(indexLastPerson, descriptor);
    ...
    public void execute_noFieldSpecifiedUnfilteredList_success() {
        EditMemberCommand editMemberCommand = new EditMemberCommand(INDEX_FIRST_PERSON, new EditPersonDescriptor());
    ...
    public void execute_duplicatePersonUnfilteredList_failure() {
        ...
        assertCommandFailure(editMemberCommand, model, commandHistory, EditMemberCommand.MESSAGE_DUPLICATE_PERSON);
    }
    ...
    public void execute_invalidPersonIndexUnfilteredList_failure() {
        ...
        assertCommandFailure(editMemberCommand, model, commandHistory, Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);
    }
    ...
    @Test
    public void equals() {
        final EditMemberCommand standardCommand = new EditMemberCommand(INDEX_FIRST_PERSON, DESC_AMY);
