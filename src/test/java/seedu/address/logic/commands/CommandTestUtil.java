...
public class CommandTestUtil {
    ...
    public static final String VALID_NAME_ROBERT = "Robert Anderson";
    public static final String VALID_PHONE_AMY = "11111111";
    public static final String VALID_PHONE_BOB = "22222222";
    public static final String VALID_PHONE_ROBERT = "33333333";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_EMAIL_ROBERT = "robert@example.com";
    ...
    public static final String VALID_DATE_TIME_BOB = "21/02/2013 12:01";
    public static final String VALID_DURATION_AMY = "1h11m";
    public static final String VALID_DURATION_BOB = "1h45m";
    public static final String VALID_TASK_DESC_AMY = "tuition homework";
    public static final String VALID_TASK_DESC_BOB = "exam preparation";
    ...
    public static final String VALID_TASK_WITH_DESC_BOB = VALID_TASK_WITHOUT_DESC_AMY + " " + VALID_TASK_DESC_AMY;
    ...
    public static final String EDUCATION_LEVEL_DESC_AMY = " " + PREFIX_EDUCATION_LEVEL + VALID_EDUCATION_LEVEL_AMY;
    public static final String EDUCATION_LEVEL_DESC_BOB = " " + PREFIX_EDUCATION_LEVEL + VALID_EDUCATION_LEVEL_BOB;
    ...
    /**
     * Updates {@code model}'s filtered persons list to show only the person at the given {@code targetIndex} in the
    ...
    /**
     * Updates {@code model}'s filtered tasks list to show only the task at the given {@code targetIndex} in the
     * {@code model}'s address book.
     */
    public static void showTaskAtIndex(Model model, Index targetIndex) {
        ...
        final LocalDateTime taskDateTime = task.getTaskDateTime();
        model.updateFilteredTaskList(t -> t.getTaskDateTime().equals(taskDateTime));
