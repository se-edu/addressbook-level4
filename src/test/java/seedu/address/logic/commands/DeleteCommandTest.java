...
public class DeleteCommandTest {
    ...
    public void executeUndoRedo_validIndexUnfilteredList_success() throws Exception {
        ...
        // undo -> reverts contact list back to previous state and filtered person list to show all persons
    ...
    public void executeUndoRedo_invalidIndexUnfilteredList_failure() {
        ...
        // execution failed -> contact list state not added into model
        assertCommandFailure(deleteCommand, model, commandHistory, Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);

        // single contact list state in model -> undoCommand and redoCommand fail
    ...
    public void executeUndoRedo_validIndexFilteredList_samePersonDeleted() throws Exception {
        ...
        // undo -> reverts contactlist back to previous state and filtered person list to show all persons
        expectedModel.undoContactList();
        assertCommandSuccess(new UndoCommand(), model, commandHistory, UndoCommand.MESSAGE_SUCCESS, expectedModel);
