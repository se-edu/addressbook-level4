...
public class UndoableCommandTest {
    private final Model model = new ModelManager(getTypicalAddressBook1(), new UserPrefs());
    private final DummyCommand dummyCommand = new DummyCommand(model);

    private Model expectedModel = new ModelManager(getTypicalAddressBook1(), new UserPrefs());
    ...
    public void executeUndo() throws Exception {
        ...
        dummyCommand.undo();
        expectedModel = new ModelManager(getTypicalAddressBook1(), new UserPrefs());
        assertEquals(expectedModel, model);
    }
