...
/**
 * As we are only doing white-box testing, we are not running the tests using complicated arguments
 * such as {@code parser.parse("1 abc 2")} as they should have been covered by the tests for
 * {@code ParserUtil#parseIndex(String)}.
 */
