...
public class AddressBookParserTest {
    ...
    public void parseCommand_delete() throws Exception {
        ...
        assertEquals(new DeleteCommand(INDEX_FIRST_PERSON), commandWord);
    ...
    public void parseCommand_edit() throws Exception {
        ...
        EditCommand commandWord = (EditCommand) parser.parseCommand(EditCommand.COMMAND_WORD + " "
                + INDEX_FIRST_PERSON.getOneBased() + " " + PersonUtil.getPersonDetails(person));
        assertEquals(new EditCommand(INDEX_FIRST_PERSON, descriptor), commandWord);
    ...
    public void parseCommand_find() throws Exception {
        ...
        assertEquals(new FindCommand(new NameContainsKeywordsPredicate(keywords)), commandWord);
    ...
    public void parseCommand_select() throws Exception {
        SelectCommand commandWord = (SelectCommand) parser.parseCommand(
                SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased());
        assertEquals(new SelectCommand(INDEX_FIRST_PERSON), commandWord);
