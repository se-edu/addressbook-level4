...
public class XmlUtilTest {
    ...
    private static final File TEMP_FILE = new File(TemporaryFilesUtil.getFilePathInSandboxFolder("tempAddressBook.xml"));
    ...
    public void saveDataToFile_validFile_dataSaved() throws Exception {
        ...
        dataToWrite = new XmlSerializableAddressBook(
                builder.withPerson(MockPersonsData.getSamplePersonsList().get(0)).withTag("Friends").build());
