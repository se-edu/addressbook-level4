...
public class TestUtil {
    ...
    private static Person[] getSamplePersonData() {
        try {
            return new Person[]{
                new Person(new Name("Ali Muster"), new Phone("9482424"), new Email("hans@google.com"),
                           new Address("4th street"), new UniqueTagList()),
                new Person(new Name("Boris Mueller"), new Phone("87249245"), new Email("ruth@google.com"),
                ...
                new Person(new Name("George Best"), new Phone("9482442"), new Email("anna@google.com"),
                           new Address("4th street"), new UniqueTagList()),
                new Person(new Name("Hoon Meier"), new Phone("8482424"), new Email("stefan@mail.com"),
                           new Address("little india"), new UniqueTagList()),
                new Person(new Name("Ida Mueller"), new Phone("8482131"), new Email("hans@google.com"),
