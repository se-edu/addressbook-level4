...
import static seedu.address.logic.commands.CommandTestUtil.VALID_NRIC_ANY;
import static seedu.address.logic.commands.CommandTestUtil.VALID_NRIC_BOB;
import static seedu.address.logic.commands.CommandTestUtil.VALID_PASSWORD_ANY;
...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            .withNric("T2457855E").withPassword("ASd654")
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withNric(VALID_NRIC_ANY)
            .withPassword(VALID_PASSWORD_ANY).withPhone(VALID_PHONE_AMY)
