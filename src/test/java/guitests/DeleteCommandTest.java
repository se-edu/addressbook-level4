...
public class DeleteCommandTest extends AddressBookGuiTest {
    ...
    public void delete() {
        ...
        currentList = TestUtil.removePersonAtIndexFromArray(currentList, targetIndex);
    ...
    private void assertDeleteSuccess(int targetIndexOneIndexed, final TestPerson[] currentList) {
        ...
        TestPerson[] expectedRemainder = TestUtil.removePersonAtIndexFromArray(currentList, targetIndexOneIndexed);
