...
import seedu.address.testutil.TestPersonsUtil;
...
public class DeleteCommandTest extends AddressBookGuiTest {
    ...
    public void delete() {
        ...
        currentList = TestPersonsUtil.removePersonAtIndexFromArray(currentList, targetIndex);
    ...
    private void assertDeleteSuccess(int targetIndexOneIndexed, final TestPerson[] currentList) {
        ...
        TestPerson[] expectedRemainder = TestPersonsUtil.removePersonAtIndexFromArray(currentList, targetIndexOneIndexed);
