...
public class DeleteCommandTest extends AddressBookGuiTest {
    ...
    public void delete() {
        ...
        currentList = TestPersonUtil.removePerson(currentList, targetIndex);
    ...
    private void assertDeleteSuccess(int targetIndexOneIndexed, final TestPerson[] currentList) {
        ...
        TestPerson[] expectedRemainder = TestPersonUtil.removePerson(currentList, targetIndexOneIndexed);
