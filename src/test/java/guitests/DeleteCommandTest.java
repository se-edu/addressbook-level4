...
public class DeleteCommandTest extends AddressBookGuiTest {
    ...
    public void delete() {
        ...
        //invalid index
        mainWindowHandle.getCommandBox().runCommand(DeleteCommand.COMMAND_WORD + " " + currentList.length + 1);
    ...
    private void assertDeleteSuccess(Index index, final Person[] currentList) {
        ...
        mainWindowHandle.getCommandBox().runCommand(DeleteCommand.COMMAND_WORD + " " + index.getOneBased());

        //confirm the list now contains all previous persons except the deleted person
        assertTrue(mainWindowHandle.getPersonListPanel().isListMatching(expectedRemainder));
