...
import static seedu.address.commands.DeletePersonCommand.MESSAGE_DELETE_PERSON_SUCCESS;
...
public class DeleteCommandTest extends AddressBookGuiTest {
    ...
    public void delete() {
        ...
        //invalid index
        runCommand("delete " + currentList.length + 1);
        assertResultMessage("The person index provided is invalid");

    }

    /**
     * Run the delete command to delete the person at specified index and confirms the result is correct.
    ...
    private void assertDeleteSuccess(int targetIndexOneIndexed, final TestPerson[] currentList) {
        ...
        runCommand("delete " + targetIndexOneIndexed);
