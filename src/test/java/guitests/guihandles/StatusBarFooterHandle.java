...
public class StatusBarFooterHandle extends NodeHandle<Node> {
    ...
    /**
     * Returns true if the current content of the sync status is different from what we last remembered.
     */
    ...
    /**
     * Returns true if the current content of the 'save location' is different from what we last remembered.
     */
