...
public class ClearCommandSystemTest extends AddressBookSystemTest {
    ...
    public void clear() throws Exception {
        /* Case: clear non-empty list, command with leading spaces and trailing spaces -> cleared */
        assertCommandSuccess("   " + ClearCommand.COMMAND_WORD + "   ");

        /* Case: clear empty list, command with trailing alphanumeric characters -> cleared */
