...
public class SystemTestSetupHelper {
    ...
    public TestApp setupApplication(Supplier<ReadOnlyAddressBook> addressBook, Path saveFileLocation,
                                    Supplier<ReadOnlyTranscript> transcript, Path saveTranscriptFileLocation) {
        try {
            FxToolkit.registerStage(Stage::new);
            FxToolkit.setupApplication(() ->
                    testApp = new TestApp(addressBook, saveFileLocation,
                            transcript, saveTranscriptFileLocation));
