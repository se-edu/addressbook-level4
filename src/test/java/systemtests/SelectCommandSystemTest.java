...
public class SelectCommandSystemTest extends ContactListSystemTest {
    @Test
    public void select() {
        ...
        /* Case: filtered person list, select index within bounds of contact list but out of bounds of person list
         * -> rejected
         */
        ...
        /* Case: filtered person list, select index within bounds of contact list and person list -> selected */
