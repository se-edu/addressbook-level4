...
public class EditCommandSystemTest extends ContactListSystemTest {
    ...
    public void edit() {
        ...
        assertTrue(getModel().getContactList().getPersonList().contains(BOB));
        ...
        /* Case: filtered person list, edit index within bounds of contact list and person list -> edited */
        ...
        /* Case: filtered person list, edit index within bounds of contact list but out of bounds of person list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
