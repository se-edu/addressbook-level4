...
public class DeleteCommandSystemTest extends ContactListSystemTest {
    ...
    public void delete() {
        ...
        /* Case: filtered person list, delete index within bounds of contact list and person list -> deleted */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        Index index = INDEX_FIRST_PERSON;
        assertTrue(index.getZeroBased() < getModel().getFilteredPersonList().size());
        assertCommandSuccess(index);

        /* Case: filtered person list, delete index within bounds of contact list but out of bounds of person list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        int invalidIndex = getModel().getContactList().getPersonList().size();
        ...
        Index outOfBoundsIndex = Index.fromOneBased(
                getModel().getContactList().getPersonList().size() + 1);
    ...
    /**
     * Removes the {@code Person} at the specified {@code index} in {@code model}'s contact list.
     ...
     * {@code ContactListSystemTest#assertApplicationDisplaysExpected(String, String, Model)}.
     ...
     * @see DeleteCommandSystemTest#assertCommandSuccess(String, Model, String)
     * @see ContactListSystemTest#assertSelectedCardChanged(Index)
     */
    private void assertCommandSuccess(String command, Model expectedModel, String expectedResultMessage,
