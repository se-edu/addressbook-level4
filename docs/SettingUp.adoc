...
1. Get some sense of the overall design by reading about
<<DeveloperGuide#Design-Architecture, AddressBook's architecture>>.
2. Take a look at <<DeveloperGuide#GetStartedProgramming, Appendix A, Suggested Programming Tasks to Get Started>>.
