...
To compile the application into a JAR, we have defined custom tasks  [maven repositories](https://maven.apache.org/guides/introduction/introduction-to-repositories.html) in `build.gradle` for the script to download each of them.
