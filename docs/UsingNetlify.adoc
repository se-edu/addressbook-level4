...
+
image:netlify/GrantOrRequestAccess.png[Grant or request access, width = 630]
...
+
image:netlify/TempSiteName.png[Temporary site name, width = 630]
+
...
+
image:netlify/NetlifyDetails.png[Netlify details link, width = 630]
...
+
image:netlify/ChangeSiteName.png[Change site name, width = 630]
