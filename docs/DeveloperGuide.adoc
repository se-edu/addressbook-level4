...
.  Make sure you have followed the <<UsingGradle#rendering-asciidoc-files, UsingGradle.adoc>> instructions to convert the AsciiDoc files in `docs` to HTML format.
