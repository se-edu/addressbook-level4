...
|`*` |user|create hierarchy|organize the tasks in a logical classification

|`*` |user|edit hierarchy|change the structure or name of the hierarchy

|`*` |user with at least one task|view one task details|see the details and get the information of a task
...
|`*` |user with tasks|receive email reminder for the tasks deadline|be reminded for upcoming events
|=======================================================================
...
* Notes easy to remove, add, edit and move
* Have attachments and update history for an event
* Able to sync with different device for same account
* Have a lot of power ups to choose including github

Cons:

* Not command line software, so not very friendly for developers and command line lovers
