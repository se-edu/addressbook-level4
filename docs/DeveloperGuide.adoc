= Student Hand Book - Developer Guide
...
== Introduction
=== What is Student Hand Book
Student Hand Book is a desktop application for students to easily manage their
tasks, expenditure and fitness.

=== Core Team
Student Hand Book was developed and is continually being maintained and improved upon
by link:https://github.com/cs2113-ay1819s2-t08-2/main[Team T08-2]

== About this Developer Guide
This developer guide serves to assist you in making contributions to Student Hand Book.
To get started, jump to <<Setting Up>>.

== Setting up
Follow the instructions below to set up and configure 'Student Hand Book' project files on your computer.
...
* stores the Student HandBook data.
...
Our StudentHandBook is a tool for helping students manage their priorities, therefore the ability to help them document their tasks is highly essential.
...
The Student HandBook will initialize with the initial task list state and the currentStatePointer pointing to that single address book state.
...
StudentHandBook is also a tool for helping students manage their finances and spendings, therefore it is important to have a feature to help them record their expenditure regularly.
...
Our StudentHandBook is a tool for helping students manage their workout records too, having this features will aid them in recording down their previous workouts.
...
Step 1. The user launches the application for the first time.
The Student HandBook will initialize with the initial workout list state and the currentStatePointer pointing to that single address book state.
