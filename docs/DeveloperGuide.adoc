...
==== Implementation
* The expenditure list feature is facilitated by `ExpenditureList`.
 It consists of 4 components:
** `ExpenditureList#addPurchase` - Adds a new purchase to the StudentHandBook
** `ExpenditureList#expList` - Lists down the existing expenses
** `ExpenditureList#removePurchase` - Deletes an existing Purchase
** `ExpenditureList#clearExp` - Clears the expenditure list
