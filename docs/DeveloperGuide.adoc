...
.  Make sure you have followed the <<UsingGradle#rendering-asciidoc-files, UsingGradle.adoc>> instructions to convert the AsciiDoc files in the `docs/` directory to HTML format
