...
* Centralised database system with different fields so as to support various features stated below:

    Ensure correct payout to employees including bonus and salary

    Ensure expenses claimed including medication and transportation

    Ensure leave handling in a proper way

* Timetable of working schedule
* Report generation:
...
* Enable online communication via internal messenger
* Full training list
* GUI
