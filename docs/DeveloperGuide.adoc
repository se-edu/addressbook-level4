...
[TIP]
The `.pptx` files used to create diagrams in this document can be found in the link:diagrams/[diagrams] folder. To update a diagram, modify the diagram in the pptx file, select the objects of the diagram, and choose `Save as picture`.

`Main` has only one class called link:../src/main/java/seedu/address/MainApp.java[`MainApp`]. It is responsible for,
...
The `UI` component uses JavaFx UI framework. The layout of these UI parts are defined in matching `.fxml` files that are in the `src/main/resources/view` folder. For example, the layout of the link:../src/main/java/seedu/address/ui/MainWindow.java[`MainWindow`] is specified in link:../src/main/resources/view/MainWindow.fxml[`MainWindow.fxml`]
...
.  The result of the command execution is encapsulated as a `ExecutionResult` object which is passed back to the `Ui`.
...
*API* : link:../src/main/java/seedu/address/model/Model.java[`Model.java`]
...
*API* : link:../src/main/java/seedu/address/storage/Storage.java[`Storage.java`]
...
* See link:UsingGradle.md[UsingGradle.md] for how to run tests using Gradle.
...
Thanks to the https://github.com/TestFX/TestFX[TestFX] library we use, our GUI tests can be run in the _headless_ mode. In the headless mode, GUI tests do not show up on the screen. That means the developer can do other things on the Computer while the tests are running. See link:UsingGradle.md#running-tests[UsingGradle.md] to learn how to run tests in headless mode.
...
See link:UsingGradle.md[UsingGradle.md] to learn how to use Gradle for build automation.

=== Continuous Integration

We use https://travis-ci.org/[Travis CI] and https://www.appveyor.com/[AppVeyor] to perform _Continuous Integration_ on our projects. See link:UsingTravis.md[UsingTravis.md] and link:UsingAppVeyor.md[UsingAppVeyor.md] for more details.

=== Publishing Documentation

See link:UsingGithubPages.md[UsingGithubPages.md] to learn how to use GitHub Pages to publish documentation to the project site.
