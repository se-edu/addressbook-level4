...
|`* * *`|user |add a timetable entry on anyone's timetable | assign jobs to employees 
...
|`* * *`|user |change employees' rating | update my rarting record when the performance of an employee improves or 
