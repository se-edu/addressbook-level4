...
|`* * *` |salesperson |remove duplicate leads, contacts and accounts|not have redundant data in my CRM

|`* * *` |salesperson |login to LinkedIn|Sync my LinkedIn contacts

|`* * *` |salesperson |sync with LinkedIn|Know which of my contacts has changed companies
...
|`*` |salesperson |schedule a meeting using zoom |schedule meetings easily and with a link other salespeople can use
...
[[zoom]] Zoom::
A digital conferencing platform
