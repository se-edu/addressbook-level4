...
See <<UsingTravis#deploy-github-pages, UsingTravis.adoc>> to learn how to deploy GitHub Pages using Travis.

.  Go to your repository's `Settings -> Options -> GitHub Pages`.
.  Ensure that the `Source` is set to `gh-pages branch`.
.  Under `Theme Chooser`, click `Choose a theme` and select a theme of your choice.
.  Go back to `Settings -> Options -> GitHub Pages`, you should see the message `Your site is ready to be published at \https://<your-username-or-organization-name>.github.io/addressbook-level4/.`
.  Click the link and you will see your documentation on your GitHub pages.
...
.  Make sure you have set up GitHub Pages as described in #publishing-documentation[Publishing Documentation].
