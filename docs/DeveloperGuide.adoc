...
See https://pages.github.com[GitHub Pages] to learn how to use GitHub Pages to publish documentation to the project site.

.  Convert the AsciiDoc files in `docs` to HTML format, see <<UsingGradle#rendering-asciidoc-files, UsingGradle.adoc>>.
.  Copy all the generated files and folders (E.g. HTML files and images folder) in `build/docs` and place it into the `project folder` that you have setup for GitHub Pages.
.  Push it and you will be able to see your documentation on `\https://<your-username-or-organization-name>.github.io`
...
.  Make sure you have set up GitHub Pages as described in <<DeveloperGuide#54-publishing-documentation, 5.4>>.
.  Using Chrome, go to the HTML link of the documentation file. e.g. For <<UserGuide#, UserGuide.adoc>>, the URL will be `\https://<your-username-or-organization-name>.github.io/addressbook-level4/docs/UserGuide.html`.
