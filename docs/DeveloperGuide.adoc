...
|`* *` |user |easily input the commands as the systems learn the behaviour and common commands that I had in the past |auto-correct my words
...
Command Line Interface (CLI)
 +
link:http://searchwindowsserver.techtarget.com/definition/command-line-interface-CLI[Full Definition]
...
Natural Language
 +
link:http://whatis.techtarget.com/definition/natural-language[Full Definition]
....
...
Sluggishness
 +
link:https://www.nngroup.com/articles/response-times-3-important-limits/[Response Times: The 3 Important Limits]

....
Respond time of greater than 1 second upon user input
....
