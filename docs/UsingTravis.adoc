...
+
image:travis/SigningIn.png[Signing into Travis CI]
+
...
+
image:travis/ReviewAndAdd.png[Review and add]
+
...
+
image:travis/GrantAccess.png[Grant Access]
+
or request access
+
image:travis/RequestAccess.png[Request Access]
+
to Travis CI so that it can access your commits and build your code.
* If repository cannot be found, click `Sync account`
.  Activate the switch.
+
image:travis/FlickRepositorySwitch.png[Activate the switch]
+
...
+
image:travis/GenerateToken.png[Generate token]
...
--
image:travis/TravisAddToken.png[Travis add token]
+
[NOTE]
