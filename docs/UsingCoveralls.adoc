...
Coveralls automatically comments on the coverage type of the pull requests in GitHub. If it's a hindrance, you can disable it in the settings of your project in Coveralls:
