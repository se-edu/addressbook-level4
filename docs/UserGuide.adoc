...
=== Retrieving previous and next input

Pressing the kbd:[&uarr;] and kbd:[&darr;] arrows respectively will display the previous and next input respectively in the command box.
