...
* In v 1.2: Able to add leads into CRM book and convert leads into contacts. Able to do some smart deduplication detection. Able to start process of LinkedIn Integration

* In v 1.3: Introduce calander for meetings. Smarter deduplication detection. Able to fully authenticate linkedIn, and link contacts to linkedIn

* In v 1.4: Able to book meetings using the calander. Deduplication becomes even smarter. CRM Book will alert you if a contact switches companies.
...
=== Log in to LinkedIn : 'linkedin_login' (Half implemented)
