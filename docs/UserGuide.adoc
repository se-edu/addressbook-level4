...
[NOTE]
====
* As of v1.2, the only export types are CALENDAR and PORTFOLIO.
* As of v1.2, the application only handles the command. The actual export of the data files will come in later versions.
====
