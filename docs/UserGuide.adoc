...
* **`add`**`John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01` : adds a contact named `John Doe` to the Address Book.
...
Lists all the commands that you have entered. +
Format: `history`
