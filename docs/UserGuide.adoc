...
View the leave/off application of specific employee and edit the type.

Format: `leaveRequest id/EMPLOYEE_ID`

* View the list of employees with leave/off request

* Select the employee name to change the leave request type
...
=== Locating schedules by name: `find`
