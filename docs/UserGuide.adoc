...
* or Usage: According to the conditions written, if at least one of them passes with the regarding person in the address book, the person
is included in the filtered version.
* and Usage: According to the conditions written, if every single one of them passes with the regarding person in the address book, the person
is included in the filtered version.
