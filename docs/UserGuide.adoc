...
* All the operations, that change the content of the applicant pool also clears every single filter.
* After one filtering, the filtered applicant pool can be filtered again.
